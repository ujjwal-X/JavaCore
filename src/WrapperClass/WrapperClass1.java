...
public class WrapperClass1 {
    public static void main(String[] args) {
        ...
        // Converting primitive data type corresponding to its non-primitive data type wrapper type is called AutoBoxing
        Integer num2= num;
        ...
        System.out.println("explicity converting "+i);
